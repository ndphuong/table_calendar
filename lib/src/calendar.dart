...
class _TableCalendarState extends State<TableCalendar>
  ...
  TableRow _buildDaysOfWeek() {
    return TableRow(
      decoration: BoxDecoration(color: widget.daysOfWeekStyle.backgroundColor),
      children:
  ...
  TableRow _buildTableRow(List<DateTime> days, int weekIndex) {
    return TableRow(
        decoration: BoxDecoration(
            color: weekIndex % 2 == 0 ? Color(0xffE8FAFF) : Color(0xffC8F3FF)),
